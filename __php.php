...
/*
|--------------------------------------------------------------------------
| Defining the endpoints Update levels
| 
| This array defines the access levels for updating resources through API endpoints.
| Each key represents an endpoint, and the corresponding value is an array
| specifying the access level required to perform updates. 
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Defining the endpoints Create levels
| 
| This array defines the access levels for creating resources through API endpoints.
| Each key represents an endpoint, and the corresponding value is an array
| specifying the access level required to perform creation.
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Defining the endpoints Delete levels
| 
| This array defines the access levels for deleting resources through API endpoints.
| Each key represents an endpoint, and the corresponding value is an array
| specifying the access level required to perform deletion.
|--------------------------------------------------------------------------
*/
...
/*
|--------------------------------------------------------------------------
| Defining the endpoints OPTIONS levels
| 
| This array defines the access levels for handling OPTIONS requests through API endpoints.
| Each key represents an endpoint, and the corresponding value is an array
| specifying the access level required to handle OPTIONS requests.
|--------------------------------------------------------------------------
*/
...
define('RESET_PASSPHRASE_UUID', '');// change

define('SYSTEM_KEY', ''); //change
